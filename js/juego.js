...
function moverEnDireccion(direccion) {
        ...
        if (posicionValida(nuevaFilaPiezaVacia, nuevaColumnaPiezaVacia) == true) {
            ...
            document.getElementById('contador').innerText="Movimientos: "+cont;
        }
...
function mezclarPiezas(veces) {
    ...
    cont=0;
    if(veces == 1) {
      document.getElementById('contador').innerText="Comenza!";
    }
    else {
    document.getElementById('contador').innerText="Mezclando...";
    }
}
